...
An increase in dimension caused a corresponding increase in the query
time of the odds-on tree and kd-tree implementations. It also caused the
relative performance of the odds-on tree to become worse. In two or three
dimensions and low search set sigma, the odds-on tree outperforms the kd-tree.
...
is likely caused by the decreased effectiveness of a fixed sample size as
...
tree and kdtree did not change with increased point set size. If the odds-on tree
