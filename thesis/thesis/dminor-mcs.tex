...
the early 1970s \cite{knuth} \cite{kdtree}.
...
%TODO: example of geometric search tree
...
the same predetermined number of nearest neigbhours, which would result in each
...
avoid problems with numerical and geometrical robustness \cite{TODO}.
...
in the figure below ~\ref{fig:no_finite_tree}. The blue line bisecting the two points
can not be represented with a finite number of axis aligned boxes.
...
Empirical evidence suggests that in problems with 16 dimensions or
...
%TODO: better justification of comparison based structures
