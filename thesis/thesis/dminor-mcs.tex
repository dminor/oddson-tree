...
%%TODO: look some more for datasets with search information 
...
\label{fig:point_set_size_qtime_4d_0_50}
\end{center}
\end{figure}
...
\caption{Odds-on Tree Build Time(2d, pts=10000)}
...
\caption{Odds-on Tree Query Time(2d, pts=10000)}
...
\caption{Odds-on Tree Total Time(2d, pts=10000)}
\label{fig:sample_set_size_total}
\end{center}
\end{figure}

%TODO: more on sample set size - recommendations on how to choose it, maybe?
%TODO: graph odds-on tree node count, hit rates for different sample sizes?
...
\caption{Odds-on Tree Build Time(3d, pts=10000, sample=5000)}
...
\caption{Odds-on Tree Query Time(3d, pts=10000, sample=5000)}
...
\begin{center}
\includegraphics[scale=0.5]{diagrams/kt_3d_pts10000_sample5000_ctime.eps}
\caption{Odds-on Tree Total Time(3d, pts=10000, sample=5000)}
...
\bibitem{digitalocean} DigitalOcean
%%TODO
