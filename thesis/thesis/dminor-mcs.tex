...
The dimension of the point sets is varied across 2, 3, 4, and 8 and 16
...
The number of points in the point set is varied across 1000, 500, 10000, and
100000 points. More points were tested but required considerably amounts of time
...
%TODO:
% K - 1, 5, 10, 50? -- seemed to be limited benefit beyond doing 1 or 2
% epsilon -- any useful way to do approximate queries?
...
these times to be compared as well as the overall running time.
