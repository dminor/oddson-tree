...
contains experimental results that show that practical implementations for the
biased nearest neigbhour search problem are possible.
...
I not sure I would have made it this far without the patience, kindness and
support of my wife April.
...
if given a suitable probability distribution over the searches.
...
of RAM, and 30 GB SSD secondary storage. The digital ocean instance was found
to considerably faster and so more cost-effective than an Amazon Web Services
EC2 Medium Compute Optimized instance, with two 64-bit processors and 1.7GB of
RAM. This is likely due to the Amazon instance type not providing SSD backed
storage and so becoming I/O bound reading queries and writing results to disk.
