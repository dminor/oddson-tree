...
A linear decision tree is a search tree where the child node to visit next
is determined by a linear function of point coordinates. A comparison tree is a
search tree where the decision of which child node to visit is based upon making
a comparison of coordinates.
