...
When considering distribution sensitive point location convex partitions or
triangulations of the plane are often considered rather than arbitrary
subdivisions. A convex subdivision is one where all of the faces except the
outer are convex polygons, and a triangulation is one where all of the faces
are triangles \cite{distsenspointloc}.

TODO: John Iacono and Arya et al. proved for triangulations that 
...
\begin{thm} \emph{(Distribution Sensitive Point Location in a Convex Subdivison)} 
...
TODO: Refer to at least Biased Range Trees paper
...
\bibitem{distsenspointloc}
Collette, S., Iacono, J., Langerman, S., Morin, P. (200x) Distribution-Sensitive
Point Location in Convex Subdivisions, TODO
