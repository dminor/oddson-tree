...
number of elements in a set contained within a query space. The 2-sided
...
A simple entropy-based algorithm for planar point
location. In Proceedings of the Twelfth Annual ACM-SIAM Symposium on Discrete Algorithms, pages
262–268, 2001.
