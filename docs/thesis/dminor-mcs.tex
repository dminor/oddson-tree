...
search time \(O(n)\).
 ...
 His analysis of Rule II shows that the expected search
...
than biased search trees. In practice, splaytrees have better performance and
are as easy to implement, and so these data structures are not discussed
further \cite{minor}.
